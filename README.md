...
Приложение — это **полноценное PWA** с поддержкой:
- ✅ **Offline-режим** — работает без интернета
- ✅ **Installable** — можно установить на телефон как приложение
- ✅ **Service Worker** — кеширование и фоновая синхронизация
...
Полная документация по PWA и подготовке к публикации в App Store/Google Play:
- [DEVELOPER_HANDOFF.md](DEVELOPER_HANDOFF.md) - Comprehensive guide
- [ICON_GENERATION.md](ICON_GENERATION.md) - Icon specifications
...
### v1.2 (2025-12-02)
- **PWA Implementation:**
  - Service Worker с offline-режимом
  - Installable app (Add to Home Screen)
  - Branded offline fallback page
  - PWA manifest с shortcuts
- **Performance Optimizations:**
  - Gzip compression (60-70% size reduction)
  - Aggressive caching (1 year for static assets)
  - Tree-shaking для Lucide icons
  - DNS prefetch для API домена
  - Bundle analyzer tool
- **Developer Experience:**
  - Comprehensive DEVELOPER_HANDOFF.md (500+ lines)
  - ICON_GENERATION.md guide
  - Production-ready для app stores
- **Cleanup:**
  - Removed unused DaData API routes
  - Removed non-working CRM customizations
  - Updated .gitignore

### v1.1 (2025-12-02)
- **Frontend:**
  - Редизайн главной страницы (mobile-first)
  - Улучшенная форма заявки с иконками и маской телефона
  - Упрощен ввод адреса (обычное текстовое поле)
  - Исправлен "гуляющий" подвал (sticky footer)
  - Добавлены SEO мета-теги
- **Infrastructure:**
  - Отключен GitHub Actions (переход на ручной деплой)

### v1.0.0 (2025-12-02)
- Первый релиз
- Базовая настройка сервера и Docker
- Интеграция Next.js + EspoCRM
