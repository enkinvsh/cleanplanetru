...
### v1.1 (2025-12-02)
- **CRM:**
  - Отключены вкладки "Главная" и "Контрагенты" для упрощения интерфейса.
  - Удалена панель "Деятельность" из карточки Лида.
  - Источники лидов переведены на русский язык (Сайт, Телефон, и т.д.).
- **Frontend:**
  - Редизайн главной страницы (2 колонки на десктопе).
